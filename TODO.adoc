...
. link:src/sql/threat-hour-protocol.sql[Threats over the last 24 hours]
. link:src/sql/threat-resolved-hour-protocol.sql[Resolved threats over the last 24 hours]
. link:src/sql/mac_ip_joined.sql[New MAC and IP addresses added, by hour, last 24 hours]
. link:src/sql/hosts-contacting-decoys.sql[Hosts contacting decoys over the last 24 hours]
